...
1. _Python'ı yükleyin_: Eğer Python yüklü değilse, [Python Resmi Web Sitesi](https://www.python.org/downloads/) üzerinden Python'u indirip kurun.
2. _Gerekli Kütüphaneleri Yükleyin_: Terminal veya komut satırına şu komutu girin:
   bash
   pip install pygame
